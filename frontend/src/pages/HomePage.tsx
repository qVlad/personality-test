...
export default function HomePage(): JSX.Element {
  ...
  return (
    <div className="home-page">
      <div className="card text-center">
        <h1>Тест на архетип личности</h1>
        <p className="description">
          Узнайте свой архетип личности по методологии PrinciplesYou.
          Ответьте на 24 вопроса, чтобы определить один из 28 архетипов.
        </p>

        <div className="info-section">
          <h2>Как это работает?</h2>
          <ul>
            <li>Тест содержит 24 вопроса</li>
            <li>Выберите ответ, который лучше описывает вас</li>
            <li>Вы можете вернуться к предыдущим вопросам</li>
            <li>Получите детальный профиль ваших черт личности</li>
          </ul>
        </div>
